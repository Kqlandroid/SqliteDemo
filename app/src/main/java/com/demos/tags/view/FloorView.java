...
public class FloorView extends LinearLayout {
     ...
     * @param refers 数据列表
     */
    public void setComments(List<DetailComment.ResultBean.ItemsBean.ReferBeanX> refers) {
        // 清除子View
        removeAllViews();
     ...
     * @param refers 评论数据列表
     */
    private void initViewWithAll(List<DetailComment.ResultBean.ItemsBean.ReferBeanX> refers) {
     ...
     * @param refers 评论数据列表
     */
    private void initViewWithHide(final List<DetailComment.ResultBean.ItemsBean.ReferBeanX> refers) {
     ...
     * @return 一个评论子视图
     */
    private View getView(DetailComment.ResultBean.ItemsBean.ReferBeanX refer, int index, int count, boolean isHide) {
        ...
        if (isHide) {
            ...
            // 设置显示数据
            tvUserName.setText(refer.getAuthor());
